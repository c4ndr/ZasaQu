...
const FALLBACK = { app_name: 'ZasaQu', app_tagline: '', app_logo_url: null, maintenance_mode: false, wallet_enabled: false, app_min_version: '1.0.0', features: DEFAULT_FEATURES }
