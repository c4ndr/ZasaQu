    ...
    <div style={{ minHeight: '100dvh', background: 'var(--k-bg)', paddingBottom: 80 }}>
      ...
      <div style={{ padding: 16 }}>
        {loading ? (
          ...
          return (
            <div key={order.id} onClick={() => navigate(`/serv/orders/${order.id}`)}
              style={{ background: 'var(--k-card)', borderRadius: 16, padding: 16, marginBottom: 12, cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
